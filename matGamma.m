...
% 
%       D = matGamma(SIZE,'gradient')   crée la matrice de taille SIZE du 
%       gradient par différences finies à droite en 1D
%       . SIZE = size(x) avec x le signal d'origine
% 
%       [Dx,Dy] = matGamma(SIZE,'gradient')   crée la matrice de taille SIZE 
%       du gradient par différences finies à droite en 2D
%       . SIZE = size(x) avec x l'image d'origine non vectorisée
%                                      
% 
%     Ex 1 (1D): 
%       t = [-10:.1:10]';
